...
<ul>
    <li><a href="${ctx}/category_list.action" target="mainFrame"><i></i>分类管理</a></li>
    <li><a href="${ctx}/article_pagelist.action" target="mainFrame"><i></i>文章管理</a></li>
    <li><a href="${ctx}/log_account.action" target="mainFrame"><i></i>用户管理</a></li>
</ul>
