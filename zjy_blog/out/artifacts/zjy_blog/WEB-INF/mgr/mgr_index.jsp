...
<frameset rows="70,*" frameborder=0 border="0" framespacing="0">
    <frame src="${ctx}/log_top.action" name="topFrame" scrolling="NO" noresize>
    <frameset cols="250,*" frameborder="0" border="0"  framespacing="10">
        <frame src="${ctx}/log_left.action" name="leftFrame" scrolling="NO">
        <frame src="${ctx}/article_pagelist.action" name="mainFrame" >
    </frameset>
</frameset>
